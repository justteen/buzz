...
from BuzzMusicBot.utils.database import (delete_authuser, get_authuser,
                                       get_authuser_names,
                                       save_authuser)
from BuzzMusicBot.utils.decorators import AdminActual, language
from BuzzMusicBot.utils.formatters import int_to_alpha
...
from BuzzMusicBot.utils.database import is_muted, mute_off
...
async def unmute_admin(Client, message: Message, _, chat_id):
    ...
    await BuzzBot.unmute_stream(chat_id)
