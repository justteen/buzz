...
from BuzzMusicBot.misc import SUDOERS
from BuzzMusicBot.utils import help_pannel
from BuzzMusicBot.utils.database import get_lang, is_commanddelete_on
from BuzzMusicBot.utils.decorators.language import (LanguageStart,
                                                  languageCB)
from BuzzMusicBot.utils.inline.help import (help_back_markup,
                                          private_help_panel)
...
from BuzzMusicBot.utils.database import is_music_playing, music_off
...
async def pause_admin(cli, message: Message, _, chat_id):
    ...
    await BuzzBot.pause_stream(chat_id)
    await message.reply_text(
