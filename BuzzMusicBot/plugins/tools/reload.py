...
from BuzzMusicBot.utils.database import get_authuser_names, get_cmode
from BuzzMusicBot.utils.decorators import (ActualAdminCB, AdminActual,
                                         language)
from BuzzMusicBot.utils.formatters import alpha_to_int
...
async def restartbot(client, message: Message, _):
    ...
    try:
        db[message.chat.id] = []
        await BuzzBot.stop_stream(message.chat.id)
    except:
        pass
